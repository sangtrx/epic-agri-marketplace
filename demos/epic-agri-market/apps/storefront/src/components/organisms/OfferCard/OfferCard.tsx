...
import { OfferLot } from "@/components/cells/OfferLot/OfferLot"
  ...
  return (
    ...
    >
        ...
        >
          <div className="overflow-hidden rounded-sm w-full h-full flex justify-center align-center">
            <Image
              ...
              className="object-cover aspect-square w-full object-center h-full rounded-xs"
      ...
      <div className="flex flex-col gap-3 p-4" data-testid="offer-card-info">
          ...
          <div className="flex items-center gap-2 mt-2" data-testid="offer-card-price">
            {displayPrice ? (
              <p className="font-medium" data-testid="offer-card-current-price">
                {displayPrice} <span className="text-sm font-normal">/ pack</span>
              </p>
            ) : (
        ...
        <LocalizedClientLink href={`/sellers/${offer.seller?.handle}`} className="epic-offer-seller">{offer.seller?.name}</LocalizedClientLink>
        <OfferLot metadata={offer.metadata} stock={stock} compact />
        <Button
